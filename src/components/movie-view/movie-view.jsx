...
export const MovieView = ({ favorites, toggleFavoriteMovie }) => {
  ...
  return (
    <div>
      <Row className="d-flex flex-column flex-xs-column flex-sm-column flex-md-row flex-lg-row justify-content-center">
        ...
        <div className="col">
          <Col>
            ...
            <div>
              ...
              (movie.director.Death && <span>{movie.director.Death.slice(0, 10)}</span> : <span>N/A</span>)
            </div>
            <div>
              <span>Actors: </span>
